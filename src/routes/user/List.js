...
class List extends Component {
  ...
  render() {
    ...
    const getBodyWrapper = body => { return this.props.isMotion ? <AnimTableBody {...getBodyWrapperProps} body={body} /> : body }
    ...
    return (
      <div>
        <Table
          ...
          className={classnames({ [styles.table]: true, [styles.motion]: this.props.isMotion })}
          bordered
          scroll={{ x: 1250 }}
          columns={columns}
          simple
